            ...
            da = o("s_light-color-input").value;
        {
            ...
            (function (e, t, n, o, r, da, c) {
               ...
               /* const imageInput = document.getElementById('qr-image-input');
                if (imageInput.files.length == null) {
                    const img = new Image();
                    img.src = URL.createObjectURL(imageInput.files[0]);
                    img.onload = function () {
                        const imgSize = Math.floor(i / 3); // Размер изображения (можете изменить по желанию)
                ...
                // Проверка наличия изображения и добавление его в центр QR-кода
